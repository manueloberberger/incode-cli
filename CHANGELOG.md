...
### Changed
- Allow current major releases of Rich, ReportLab, python-telegram-bot,
  icalendar, pytest and mypy while retaining Python 3.9-compatible resolution.
- Replace aioresponses-based HTTP tests with a local aiohttp test server,
  including real login-cookie handling, to support aiohttp 3.14 and later 3.x.
